...
urlpatterns = [
    ...
    path(
        "pets/<int:pet_id>/photos/<int:photo_id>/primary",
        pets.pet_photo_set_primary,
        name="pet-photo-primary",
    ),
    path(
        "pets/<int:pet_id>/photos/<int:photo_id>",
        pets.pet_photo_delete,
        name="pet-photo-delete",
    ),
    ...
    path("pets/<int:pet_id>/lost", nfc.pet_lost_status, name="pet-lost-status"),
    path("pets/<int:pet_id>/tags", nfc.list_pet_tags, name="pet-tags"),
    ...
    path("nfc/pets/<int:pet_id>/found-reports", nfc.list_found_reports, name="nfc-found-reports"),
    ...
    path("blog/categories", blog.categories, name="blog-categories"),
    path("blog/tags", blog.tags, name="blog-tags"),
    ...
    path("shop/shipping-quote", shop.shipping_quote, name="shop-shipping-quote"),
    ...
    path(
        "vendor/orders/<int:order_id>/shipment",
        vendor.vendor_order_shipment,
        name="vendor-order-shipment",
    ),
    path("vendor/earnings", vendor.vendor_earnings, name="vendor-earnings"),
    path("vendor/statements", vendor.vendor_statements, name="vendor-statements"),
    path("vendor/payouts", vendor.vendor_payouts, name="vendor-payouts"),
    path("seller/account", vendor.seller_account, name="seller-account"),
